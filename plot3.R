...
# appropriate data for analysis into R and replicating Plot 3 of this project. The download
...
#GENERATE PLOT
# Plot 3 - Energy Sub Metering Line Plots
...
lines(x, y2, col = "red")
lines(x, y3, col = "blue")
legend("topright",names(selectedDates[7:9]),lty=c(1,1,1), lwd=c(1,1,1), col=c("black","red","blue"))
dev.off()
